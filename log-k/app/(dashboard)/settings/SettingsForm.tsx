...
export default function SettingsForm({ initialData, userId }: SettingsFormProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      // Update user profile - using 'id' as primary key
      const { error } = await supabase
        ...
        .upsert({
          ...
          // Note: email_notifications, dark_mode, language don't exist in DB
          // Could be stored in local storage or a separate settings table
